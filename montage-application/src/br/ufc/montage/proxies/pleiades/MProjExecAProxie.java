...
public class MProjExecAProxie extends MontageShelfComputationComponent{
	...
	public void setServices(IHShelfService services) {
		...
		this.goPortTask.setName("mprojexec-go-A");
		try {
			this.services.registerTaskPort(goPortTask);
			this.services.registerUsesPort("mprojexec-tbl-port-uses-A", MontageTypes.TBL_TYPE);
			this.services.registerUsesPort("mprojexec-dir-port-uses-in-A", MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("mprojexec-dir-port-uses-out-A", MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("mprojexec-hdr-port-uses-A", MontageTypes.HDR_TYPE);
		...
		this.tblPortProvides.setName("mprojexec-tbl-port-provides-A");
		try {
	...
	public void go() {
		...
		try {
			this.tblPortUses = (HShelfUsesPort)this.services.getPort("mprojexec-tbl-port-uses-A");
			this.dirPortUsesIn = (HShelfUsesPort)this.services.getPort("mprojexec-dir-port-uses-in-A");
			this.dirPortUsesOut = (HShelfUsesPort)this.services.getPort("mprojexec-dir-port-uses-out-A");
			this.hdrPortUses = (HShelfUsesPort)this.services.getPort("mprojexec-hdr-port-uses-A");
