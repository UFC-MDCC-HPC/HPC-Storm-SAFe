...
public class MAddBProxie extends MontageShelfComputationComponent {
	...
	public void setServices(IHShelfService services) {
		...
		this.goPortTask.setName("madd-go-B");

		try {
			this.services.registerTaskPort(goPortTask);
			this.services.registerUsesPort("madd-tbl-port-uses-B",
					MontageTypes.TBL_TYPE);
			this.services.registerUsesPort("madd-dir-port-uses-B",
					MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("madd-hdr-port-uses-B",
		...
		this.fitsPortProvides.setName("madd-fits-port-provides-B");
