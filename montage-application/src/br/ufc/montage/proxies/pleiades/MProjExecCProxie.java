...
public class MProjExecCProxie extends MontageShelfComputationComponent{
	...
	public void setServices(IHShelfService services) {
		...
		this.goPortTask.setName("mprojexec-go-C");
		try {
			this.services.registerTaskPort(goPortTask);
			this.services.registerUsesPort("mprojexec-tbl-port-uses-C", MontageTypes.TBL_TYPE);
			this.services.registerUsesPort("mprojexec-dir-port-uses-in-C", MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("mprojexec-dir-port-uses-out-C", MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("mprojexec-hdr-port-uses-C", MontageTypes.HDR_TYPE);
		...
		this.tblPortProvides.setName("mprojexec-tbl-port-provides-C");
		try {
	...
	public void go() {
		...
		try {
			this.tblPortUses = (HShelfUsesPort)this.services.getPort("mprojexec-tbl-port-uses-C");
			this.dirPortUsesIn = (HShelfUsesPort)this.services.getPort("mprojexec-dir-port-uses-in-C");
			this.dirPortUsesOut = (HShelfUsesPort)this.services.getPort("mprojexec-dir-port-uses-out-C");
			this.hdrPortUses = (HShelfUsesPort)this.services.getPort("mprojexec-hdr-port-uses-C");
