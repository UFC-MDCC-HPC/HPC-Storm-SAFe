...
public class MAddAProxie extends MontageShelfComputationComponent {
	...
	public void setServices(IHShelfService services) {
		...
		this.goPortTask.setName("madd-go-A");

		try {
			this.services.registerTaskPort(goPortTask);
			this.services.registerUsesPort("madd-tbl-port-uses-A",
					MontageTypes.TBL_TYPE);
			this.services.registerUsesPort("madd-dir-port-uses-A",
					MontageTypes.DIR_TYPE);
			this.services.registerUsesPort("madd-hdr-port-uses-A",
		...
		this.fitsPortProvides.setName("madd-fits-port-provides-A");
