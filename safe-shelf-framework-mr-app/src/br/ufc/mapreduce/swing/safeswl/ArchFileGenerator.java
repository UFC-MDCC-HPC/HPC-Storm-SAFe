package br.ufc.mapreduce.swing.safeswl;
...
public class ArchFileGenerator {
	...
	public String generateComponentXML(MapReduceComponent component){
		...
		if (comp_name.startsWith("Data"))
			res +="<tns:repository name=\""+comp_name+"\" id=\""+comp_id+"\">\n";
		else if(comp_name.equalsIgnoreCase("Splitter") || comp_name.equalsIgnoreCase("Shuffler"))
			res +="<tns:connector name=\""+comp_name+"\" id=\""+comp_id+"\">\n";
		else res +="<tns:computation name=\""+comp_name+"\" id=\""+comp_id+"\">\n";
