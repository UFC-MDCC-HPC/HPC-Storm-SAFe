...
import br.ufc.mapreduce.app.MRApplicationNovo;
import br.ufc.mapreduce.swing.dao.MapReduceComponentDAO;
import br.ufc.mapreduce.swing.model.MapReduceComponent;
import br.ufc.mapreduce.swing.safeswl.ArchFileGenerator;
import br.ufc.mapreduce.swing.safeswl.FlowFileGenerator;
	...
	public MapReduceAppMain() {
		...
		menuItemRun.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				MRApplicationNovo applicationMR = new MRApplicationNovo("mr-application");
