 ...
 * generated in the br.ufc.m101.stubs.mbgmodel.env package. 
...
public class ObjectFactory {
    ...
    private final static QName _SetParams_QNAME = new QName("http://mbgmodel.component.m101.ufc.br/", "setParams");
    private final static QName _SetParamsResponse_QNAME = new QName("http://mbgmodel.component.m101.ufc.br/", "setParamsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.ufc.m101.stubs.mbgmodel.env
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mbgmodel.component.m101.ufc.br/", name = "setParams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mbgmodel.component.m101.ufc.br/", name = "setParamsResponse")
