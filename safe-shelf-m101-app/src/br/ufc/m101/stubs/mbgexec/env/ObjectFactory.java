 ...
 * generated in the br.ufc.m101.stubs.mbgexec.env package. 
...
public class ObjectFactory {
    ...
    private final static QName _SetParamsResponse_QNAME = new QName("http://mbgexec.component.m101.ufc.br/", "setParamsResponse");
    private final static QName _SetParams_QNAME = new QName("http://mbgexec.component.m101.ufc.br/", "setParams");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.ufc.m101.stubs.mbgexec.env
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mbgexec.component.m101.ufc.br/", name = "setParamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mbgexec.component.m101.ufc.br/", name = "setParams")
