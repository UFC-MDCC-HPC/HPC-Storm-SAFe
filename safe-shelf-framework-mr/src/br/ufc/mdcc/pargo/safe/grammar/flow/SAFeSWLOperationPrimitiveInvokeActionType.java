...
/**
 * <p>Classe Java de SAFeSWL_OperationPrimitiveInvokeActionType complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="SAFeSWL_OperationPrimitiveInvokeActionType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.example.org/SAFe_workflow_V6}SAFeSWL_OperationPrimitiveType">
...
@XmlType(name = "SAFeSWL_OperationPrimitiveInvokeActionType")
@XmlSeeAlso({
    SAFeSWLOperationPrimitiveInvokeActionAsyncType.class
})
public class SAFeSWLOperationPrimitiveInvokeActionType
    extends SAFeSWLOperationPrimitiveType
{
