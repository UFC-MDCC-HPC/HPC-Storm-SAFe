...
/**
 * <p>Classe Java de SAFeSWL_OperationBaseType complex type.
 * 
...
@XmlType(name = "SAFeSWL_OperationBaseType")
@XmlSeeAlso({
    SAFeSWLOperationPrimitiveType.class,
    SAFeSWLOperationManyType.Iterate.class,
    SAFeSWLOperationManyType.class,
    SAFeSWLOperationAnyType.class,
    SAFeSWLOperationChoiceType.class
})
public class SAFeSWLOperationBaseType {
