 ...
 * generated in the br.ufc.mdcc.pargo.safe.sample.wspc.stubs.server.task package. 
...
public class ObjectFactory {
    ...
    private final static QName _InitializeResponse_QNAME = new QName("http://server.pc.backend.safe.pargo.mdcc.ufc.br/", "initializeResponse");
    ...
    private final static QName _Initialize_QNAME = new QName("http://server.pc.backend.safe.pargo.mdcc.ufc.br/", "initialize");
    private final static QName _SetPort_QNAME = new QName("http://server.pc.backend.safe.pargo.mdcc.ufc.br/", "setPort");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.ufc.mdcc.pargo.safe.sample.wspc.stubs.server.task
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.pc.backend.safe.pargo.mdcc.ufc.br/", name = "initializeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.pc.backend.safe.pargo.mdcc.ufc.br/", name = "initialize")
