...
public class ClientServerApplication_1 extends HShelfApplication{
	...
	public ClientServerApplication_1(String name) {
		super(name);
	}
	...
	public static void main(String[] args) {
		ClientServerApplication_1 app = new ClientServerApplication_1("client-server-app");
		app.runApplication();
	}
