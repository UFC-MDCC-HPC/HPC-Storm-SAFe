...
@XmlSeeAlso({
    XMLSAFeOperation.ChoiceOper.Alt.class,
    XMLSAFeOperation.ChoiceOper.class,
    XMLSAFeOperation.RepeatOper.Continue.class,
    XMLSAFeOperation.RepeatOper.Stop.class,
    XMLSAFeOperation.RepeatOper.class,
    XMLSAFeOperation.class,
    XMLSAFeCompOper.class,
    XMLSAFeAction.Resolve.class,
    XMLSAFeAction.Instantiate.class,
    XMLSAFeAction.Compute.class,
    XMLSAFeAction.class,
